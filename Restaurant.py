...
class AdminMenuApp:
    def __init__(self, root):
        self.root = root
        self.root.title("Restaurant Menu Editor")
        ...
        self.tree = ttk.Treeview(root, columns=("Category", "Name", "Price", "Description", "Type"), 
        ...
        self.add_btn = tk.Button(root, text="Add Item", command=self.add_item, padx=10, pady=5, bg="lightblue", font=("Arial", 10, "bold"))
        self.edit_btn = tk.Button(root, text="Edit Item", command=self.edit_item, padx=10, pady=5, bg="lightgreen", font=("Arial", 10, "bold"))
        self.delete_btn = tk.Button(root, text="Delete Item", command=self.delete_item, padx=10, pady=5, bg="salmon", font=("Arial", 10, "bold"))
        ...
        # Undo Button
        self.undo_btn = tk.Button(root, text="Undo", command=self.undo, padx=10, pady=5, bg="yellow", font=("Arial", 10, "bold"))
        self.undo_btn.grid(row=2, column=0, columnspan=3, sticky="ew")
